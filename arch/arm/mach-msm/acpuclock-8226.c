...
static struct clkctl_acpu_speed acpu_freq_tbl_8226_1p1[] = {
    // "Underclock" frequencies (96 to 249 MHz): use 0.85V
 	...
 	// Standard+Custom frequencies part 1 (300 to 883 MHz): use 0.9V to 0.99V
 	{ 1,  300000, PLL0,    4, 2,   900000,   900000, 4 },
 	{ 1,  384000, ACPUPLL, 5, 2,   920000,   920000, 4 },
 	{ 1,  499200, ACPUPLL, 5, 2,   940000,   940000, 4 },
 	{ 1,  600000, PLL0,    4, 0,   960000,   960000, 6 },
 	{ 1,  652800, ACPUPLL, 5, 0,   965000,   965000, 4 },
 	{ 1,  787200, ACPUPLL, 5, 0,   980000,   980000, 6 },
 	{ 1,  883200, ACPUPLL, 5, 0,   990000,   990000, 4 },
 	// Standard+Custom frequencies part 2 (998 MHz to 1.2 GHz): use 1V to 1.025V
 	{ 1,  998400, ACPUPLL, 5, 0,   990000,    990000,  7 },
 	{ 1, 1094400, ACPUPLL, 5, 0,   1000000,   1000000, 7 },
 	{ 1, 1190400, ACPUPLL, 5, 0,   1025000,   1025000, 7 },
 	{ 1, 1267200, ACPUPLL, 5, 0,   1025000,   1025000, 7 },
 	...
 	{ 1, 1497600, ACPUPLL, 5, 0,   1075000,   1075000, 7 },
 	{ 1, 1593600, ACPUPLL, 5, 0,   1185000,   1185000, 7 },
 	{ 1, 1689600, ACPUPLL, 5, 0,   1125000,   1125000, 7 },
    { 1, 1728000, ACPUPLL, 5, 0,   1130000,   1130000, 7 },
    { 1, 1785600, ACPUPLL, 5, 0,   1135000,   1135000, 7 },
	{ 0 }
};
